...
const sourceSpecDirectory = `automation/features/featureFiles`;
const jsonTmpDirectory = `automation/reports/json/tmp/`;
...
exports.config = {
    ...
    cucumberOpts: {
        require: ['./automation/features/step_definitions/*.js', './automation/features/support/*.js'],        // <string[]> (file/dir) require files before executing features
    ...
    onComplete: () => {
        ...
        try{
            ...
            var options = {
                theme: 'bootstrap',
                jsonFile: jsonFile,
                output: `automation/reports/html/report-${currentTime}.html`,
